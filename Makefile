...
BIN_DIR        = /usr/bin
LOADER         = git-xfer
COMMANDS       = git-xfer-push git-xfer-pull git-xfer-add git-xfer-remove git-xfer-rm git-xfer-list git-xfer-sync git-xfer-diff git-xfer-archive git-xfer-reset
